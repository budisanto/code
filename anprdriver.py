...
ap.add_argument("-a", "--algorithm", type=int, default=2,
...
image = imutils.resize(originimage, width=800, height=400)

image = cv2.bilateralFilter(image, 3, 105, 105)

#=====================================================
cv2.imshow('input',originimage)
cv2.imshow('resize-blur',image)
cv2.waitKey(0)
